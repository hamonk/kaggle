...
# adding the ',1' when applying the mask women_only_stats selects the column 1
# without it, we would get all the columns
...
predictions_file = open("output/gendermodel-python.csv", "wb")
