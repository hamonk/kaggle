...
train_df['Adult'] = (train_df.Age > 17).astype(int)
...
# fill the adult column
test_df['Adult'] = (test_df.Age > 17).astype(int)
...
predictions_file = open("output/myfirstforest_adult.csv", "wb")
